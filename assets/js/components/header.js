...
const Header = {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            ...
            <!-- Logo -->
            <a class="navbar-brand" href=${REDIRECTS.HOME}>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav me-auto"> 
                    <li class="nav-item">
                        <a class="nav-link" href=${REDIRECTS.HOME}>
                            <i class="fas fa-home"></i> ホーム
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href=${REDIRECTS.PRODUCTS}>
                ...
                <form class="d-flex me-3" id="searchForm" onsubmit="return Header.handleSearch(event)">
                    <input class="form-control me-2" type="search" placeholder="商品を検索..." id="searchInput">
                ...
                <ul class="navbar-nav">
                    ...
                    <!-- Cart -->
                    <li class="nav-item">
                        <a class="nav-link position-relative" href=${REDIRECTS.CART}>
                    ...
                    ${isAuthenticated ? `
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href=${REDIRECTS.PROFILE}>
                                        <i class="fas fa-user-circle"></i> プロフィール
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href=${REDIRECTS.ORDERS}>
                    ...
                    ` : `
                        <!-- Login/Register -->
                        <li class="nav-item">
                            <a class="nav-link" href=${REDIRECTS.LOGIN}>
                                <i class="fas fa-sign-in-alt"></i> ログイン
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href=${REDIRECTS.REGISTER}>
    ...
    handleSearch(event) {
        ...
        if (keyword) {
            window.location.href = REDIRECTS.PRODUCTS + `?keyword=${encodeURIComponent(keyword)}`;
        }
